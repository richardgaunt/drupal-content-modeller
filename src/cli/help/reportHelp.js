...
export const REPORT_HELP_DATA = {
  notes: [
    ...
    'report permissions combines role permissions and workflow assignments into a single report.'
  ],
  examples: [
    ...
    'dcm report permissions -p my-site',
    'dcm report permissions -p my-site -e node',
    'dcm report permissions -p my-site -e node -b article',
    'dcm report permissions -p my-site --format md --out ~/docs/permissions.md',
    'dcm report permissions -p my-site --format json --out -',
